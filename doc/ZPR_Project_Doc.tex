...
po³±czeniu z algorytmem \texttt{for\_each}) oraz sprytne wska¼niki
(\texttt{boost::shared\_ptr}). Godne uwagi jest zastosowanie wzorca strategii
(zwanego te¿ czasem wzorcem polityki), dziêki któremu program mo¿na
w przysz³o¶ci rozszerzyæ o dodatkowe funkcjonalno¶ci. Aktualnie domy¶lnym
zachowaniem jest wyszukiwanie zale¿no¶ci cyklicznych, natomiast dziêki
wykorzystaniu wzorca strategii ³atwo by³oby dodaæ np. modu³ wyszukuj±cy
nieu¿ywane pliki.
...
\section{Testy} \subsection{Testy manualne}
